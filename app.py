...
# 2. DESIGN PRO & SUPPRESSION DES MENTIONS STREAMLIT
st.markdown("""
    <style>
    /* Masquer le footer "Built with Streamlit" */
    footer {visibility: hidden;}
    /* Masquer le menu en haut à droite */
...
# 3. SIDEBAR (Paramètres inchangés)
with st.sidebar:
...
st.write(f"Mensualité : **{int(mensualite)} €/mois** | Capital dû au terme : **{int(m_pret if type_pret == 'In Fine' else 0)} €**")
